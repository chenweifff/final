...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalSpacer = new QSpacerItem(454, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        gridLayout->addWidget(startstopButton, 1, 1, 1, 1);
